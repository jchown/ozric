...
/// </summary>
public abstract class GraphEntity: GraphNode
{
...
//    private DateTime? lastTimeRecordedEntity;
    ...
    protected GraphEntity(string id, string entityID, List<Pin>? inputs, List<Pin>? outputs): base(id, inputs, outputs)
    {

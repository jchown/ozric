...
public class GraphSkyBrightness: GraphNode
{
    ...
    public GraphSkyBrightness(string id = "sky-brightness") : base(id, null, new() { new(Sun, ValueType.Number), new(Clouds, ValueType.Number), new(Brightness, ValueType.Number)})
    {
    }

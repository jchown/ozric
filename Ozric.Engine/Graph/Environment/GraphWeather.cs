...
public class GraphWeather: GraphEntity
{
    ...
    public GraphWeather(string id) : base(id, "weather.home", null, new() { new(State, ValueType.Mode), new(Temperature, ValueType.Number), new(Humidity, ValueType.Number), new(Pressure, ValueType.Number), new(WindBearing, ValueType.Number), new(WindSpeed, ValueType.Number)})
    {
    }

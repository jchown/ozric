...
/// </summary>
public abstract class GraphVariableInputs: GraphNode
{
    public readonly ValueType valueType;

    public GraphVariableInputs(string id, ValueType valueType, List<Pin> outputs): base(id, null, outputs)
    {
    ...
    {
        if (obj is not GraphVariableInputs vi)
            return false;

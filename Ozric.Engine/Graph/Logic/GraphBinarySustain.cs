...
public class GraphBinarySustain: GraphNode
{
    ...
    public GraphBinarySustain(string id): base(id, new List<Pin> { new(INPUT_NAME, ValueType.Binary) }, new List<Pin> { new(OUTPUT_NAME, ValueType.Binary) })
    {
    }

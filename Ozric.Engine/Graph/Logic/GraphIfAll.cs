...
public class GraphIfAll: GraphVariableInputs
{
    public static readonly string OutputName = "output";
        
    public override NodeType nodeType => NodeType.IfAll;

    public GraphIfAll(): this("")
    {
    }

    public GraphIfAll(string id): base(id, ValueType.Binary, new List<Pin> { new(OutputName, ValueType.Binary) })
    {
    }

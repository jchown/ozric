...
public class GraphModeMatch: GraphNode
{
    ...
    public GraphModeMatch(string id): base(id, new List<Pin> { new(INPUT_NAME, ValueType.Mode) }, new List<Pin> { new(OUTPUT_NAME, ValueType.Binary) })
    {

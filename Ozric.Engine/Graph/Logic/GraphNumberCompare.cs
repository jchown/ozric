...
public class GraphNumberCompare: GraphNode
{
    ...
    public GraphNumberCompare(string id): base(id, new List<Pin> { new(InputName, ValueType.Number) }, new List<Pin> { new(OutputName, ValueType.Binary) })
    {
    }

    public static GraphNumberCompare Of(string id, Comparator comparator, float a)
    {
        return new GraphNumberCompare(id)
        {
